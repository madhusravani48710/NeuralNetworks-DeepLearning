...
parser.add_argument('--weightspath', default=r'C:/Users/madhu/Downloads', type=str, help='Path to model files')
parser.add_argument('--metaname', default='model.meta', type=str, help='Name of model meta file')
...
parser.add_argument('--trainfile', default='C:/Users/madhu/Downloads/COVID-Net-master/COVID-Net-master/labels/train_COVIDx9B.txt', type=str, help='Path to train file')
parser.add_argument('--testfile', default='C:/Users/madhu/Downloads/COVID-Net-master/COVID-Net-master/labels/train_COVIDx9B.txt', type=str, help='Path to test file')
...
parser.add_argument('--label_tensorname', type=str, default='norm_dense_1/target:0', help='Name of the label tensor in the graph')

parser.add_argument('--weights_tensorname', default='norm_dense_2/sample_weights:0', type=str,
...
with tf.compat.v1.Session() as sess:
    tf.compat.v1.get_default_graph()  # Get the default graph
    for op in tf.compat.v1.get_default_graph().get_operations():
        print(op.name)
    # Corrected line for loading the meta graph
